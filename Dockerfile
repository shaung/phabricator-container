...
RUN wget -P /opt/phabricator/src/extensions/ http://github.com/wanthings/phabricator-zh_CN/raw/master/PhabricatorCNChineseTranslation.php
RUN wget -P /opt/phabricator/src/extensions/ http://github.com/wanthings/phabricator-zh_CN/raw/master/PhutilCNChineseLocale.php
